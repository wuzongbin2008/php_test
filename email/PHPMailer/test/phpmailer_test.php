...
class phpmailerTest extends TestCase
{
    ...
    function setUp() {
        ...
        $this->Mail->From = "wuzongbin2008@gmail.com";//unit_test@phpmailer.sf.net
        $this->Mail->FromName = "wu jet";//Unit Tester
        $this->Mail->Sender = "";
        $this->Mail->Subject = "jet Test";
        $this->Mail->Body = "";
        $this->Mail->AltBody = "";
        $this->Mail->WordWrap = 0;
        $this->Mail->Host ='ssl://smtp.gmail.com';// $global_vars["mail_host"];
        $this->Mail->Port = ;//25
		...
		$this->Mail->AddReplyTo("wuzongbin2008@gmail.com", "Reply Guy");
        $this->Mail->Sender = "wuzongbin2008@gmail.com";
        ...
        else
        {
            ...
            $this->Sender = "wuzongbin2008@gmail.com";
        }
