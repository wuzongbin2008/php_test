...
jQuery.extend({
	...
	data: function( elem, name, data, pvt /* Internal Use Only */ ) {
		...
		var privateCache, thisCache, ret,
			...
			// Only defining an uniqid for JS objects if its cache already exists allows
		...
		if ( !id ) {
			// Only DOM nodes need a new unique uniqid for each element since their data
...
jQuery.event = {
	...
	add: function( elem, types, handler, data, selector ) {
		...
		// Make sure that the handler has a unique uniqid, used to find/remove it later
		if ( !handler.guid ) {
	...
	(function(){
		...
		Sizzle = function( query, context, extra, seed ) {
			...
			if ( !seed && !Sizzle.isXML(context) ) {
				...
				// We can work around this by specifying an extra uniqid on the root
