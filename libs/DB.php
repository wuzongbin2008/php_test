<?php
	...
	*/
	...
	if ( ! function_exists ('mysql_connect') ) die('<b>Fatal Error:</b> DB requires mySQL Lib to be compiled and or linked in to the PHP engine');
	if ( ! class_exists ('DBShare') ) die('<b>Fatal Error:</b> DB requires DBShare (DBShare.php) to be included/loaded before it can be used');
