 ...
 * smtp.php
 *
 * @(#) $Header: /home/mlemos/cvsroot/PHPlibrary/smtp.php,v 1.16 2002/06/19 04:10:03 mlemos Exp $
 *
 */
...
class smtp_class
{
	...
	Function Connect($domain="")
	{
		...
		for($host=0;;$host++)
		{
			if(($this->connection=($this->timeout ? fsockopen($hosts[$host],$this->host_port,$errno,$error,$this->timeout) : fsockopen($hosts[$host],$this->host_port))))
				break;
