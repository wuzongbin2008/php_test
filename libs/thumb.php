...
function Thumb($file_name)
{
	...
	$Obj->img_border_color = '#ffffff';
	$Obj->setCutType(1);
	$Obj->setSrcImg(ROOT_PATH.'/upload_files/'.$file_name);
	$Obj->setDstImg(ROOT_PATH.'/upload_files/s_'.$file_name); 
	if ($Obj->src_w > $Obj->src_h)
	{
		$Obj->createImg(120,90);
		$Obj->img_border_size = 1;
		$Obj->img_border_color = '#cccccc';
		$Obj->setCutType(1);
		$Obj->setSrcImg(ROOT_PATH.'/upload_files/s_'.$file_name);
		$Obj->setDstImg(ROOT_PATH.'/upload_files/s_'.$file_name);
		$Obj->createImg(120,90);
	}else
	{
		$Obj->createImg(90,120);
		$Obj->img_border_size = 1;
		$Obj->img_border_color = '#cccccc';
		$Obj->setCutType(1);
		$Obj->setSrcImg(ROOT_PATH.'/upload_files/s_'.$file_name);
